...
static uitextmenuitem items_game[] = {
    ...
    { ID_OPTION_AUTO_APPROACH,          {OPTIONS_SCREEN_AUTOAPPROACH},          KEYCODE(4), KEYBOARD_KEY_4, TB_DOUBLE },
    
    { ID_OPTION_NIGHT_DISPLAY,          {OPTIONS_SCREEN_NIGHTDISPLAY},          KEYCODE(5), KEYBOARD_KEY_5, TB_DOUBLE },
    { ID_OPTION_BATTLE_FULL,            {OPTIONS_SCREEN_BATTLEREPORT},          KEYCODE(6), KEYBOARD_KEY_6, TB_DOUBLE },
    { ID_OPTION_NIGHT_CONFIRM,          {OPTIONS_SCREEN_NIGHTCONFIRM},          KEYCODE(7), KEYBOARD_KEY_7, TB_DOUBLE },
};
